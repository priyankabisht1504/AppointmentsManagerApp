...
export default function Home(props) {
    ...
    return (
        <main>
            ...
            />Manage Your Notes Appointments / Dates</h1>
                <p>This web applicaiton helps you to manage your Appointments dates very easy.</p>
            ...
            <div className="row underline hdr">
                ...
                <div className="column addr">Name/Address</div>
